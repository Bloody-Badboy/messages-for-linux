...
namespace
{
    ...
    auto const CONFIG_APP_DIR                        = CONFIG_DIR +  "/messages-for-linux";
    auto const CONFIG_FILE_PATH                      = CONFIG_APP_DIR + "/settings.conf";
    auto const AUTOSTART_DESKTOP_FILE_PATH           = CONFIG_DIR + "/autostart/messages-for-linux.desktop";
    ...
    constexpr auto const POSSIBLE_DESKTOP_FILE_PATHS = {
            "/usr/local/share/applications/messages-for-linux.desktop",
            "/usr/share/applications/messages-for-linux.desktop",
            "/snap/messages-for-linux/current/share/applications/messages-for-linux.desktop"
    };
