...
MainWindow::MainWindow(BaseObjectType* cobject, Glib::RefPtr<Gtk::Builder> const& refBuilder)
    ...
    , m_fullscreen{false}
{
    auto const appIcon16x16   = Gdk::Pixbuf::create_from_resource("/main/image/icons/hicolor/16x16/apps/messages-for-linux.png");
    auto const appIcon32x32   = Gdk::Pixbuf::create_from_resource("/main/image/icons/hicolor/32x32/apps/messages-for-linux.png");
    auto const appIcon64x64   = Gdk::Pixbuf::create_from_resource("/main/image/icons/hicolor/64x64/apps/messages-for-linux.png");
    auto const appIcon128x128 = Gdk::Pixbuf::create_from_resource("/main/image/icons/hicolor/128x128/apps/messages-for-linux.png");
...
void MainWindow::onAbout()
{
    ...
    aboutDialog.set_program_name("Messages for Linux");
    aboutDialog.set_comments("An unofficial Google Messages desktop application for linux.");
    aboutDialog.set_website("https://github.com/Bloody-Badboy/messages-for-linux/");
