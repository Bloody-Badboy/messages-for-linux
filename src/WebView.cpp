...
namespace
{
    constexpr auto const MESSAGES_WEB_URI = "https://messages.google.com/web/";
    ...
    void initializeNotificationPermission(WebKitWebContext* context, gpointer)
    {
        ...
        {
            auto const origin = webkit_security_origin_new_for_uri(MESSAGES_WEB_URI);
    ...
    , m_signalNotification{}
{
    ...
    webkit_web_view_load_uri(*this, MESSAGES_WEB_URI);
}
